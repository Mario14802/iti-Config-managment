...
async function saveProduct() {
  ...
  const descValid = description.length >= 10 && description.length <= 800;
  if (!title || title.length < 10 || title.length > 100 || titleHasSpecialChars || !descValid || !price || Number(price) <= 0 || !quantity || !selectedImageBase64) {
